...
5. Launch the Damru application from your desktop icon.
...
### Why do some sites still block access?
...
2. Close other resource-heavy programs while running large batches of tasks.
3. Use a high-quality internet connection to ensure the browser responds quickly.
4. Save your task settings as presets to reuse them later.
5. Check the logs folder if a task fails; the logs provide clues about what caused the issue.
